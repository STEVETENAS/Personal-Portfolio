...
<template>
  <div id="skills_body" class="py-8 bg-gray-50 dark:bg-slate-700">
    <div class="relative">
      <i class="absolute right-20 -top-6 fas fa-plus-circle fa-2x hover:bg-blue-700 hover:p-2 dark:hover:bg-transparent"
      ...
      <div class="w-[90%] m-auto text-left">
        <div class="flex justify-between">
          <p class="text-xl font-bold">
            {{ skill.skill_title }}
            <i id="edit-btn" :title="'Edit : ' + skill.diploma_title + ' info'" class="fas fa-edit edit_fas pl-2 hover:text-blue-600"
